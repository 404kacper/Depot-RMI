...
set CLASSPATH=%APP_HOME%\lib\test.jar;%APP_HOME%\lib\rmi-1.0.1.wso2v1.jar


@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" pl.edu.pwr.server.RunServer %*
